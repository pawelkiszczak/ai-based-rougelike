...
def main() -> int:
    ...
    required_files = (
        ...
        "game/tests/test_mutation_batch_61_75.gd",
        ...
        "game/tests/test_license_manifest.gd",
        "docs/LICENSES.md",
        "tools/validate_licenses.py",
        "game/export_presets.cfg",
        "game/build_metadata.json",
        "game/tests/test_build_metadata.gd",
        "docs/release-exports.md",
        "tools/validate_build_metadata.py",
        "game/sim/daily_run_config.gd",
        "game/tests/test_daily_runs.gd",
        "docs/content/daily-runs.md",
        "game/sim/narrative_system.gd",
